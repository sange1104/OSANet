...
def parse_args():
  ...
  parser.add_argument('--load_dir', dest='load_dir',
                      ...
                      default="object_detection/load_dir")
  parser.add_argument('--image_dir', dest='image_dir',
                      help='directory to load images for demo',
                      default="object_detection/images")
  ...
  parser.add_argument('--classes_dir', dest='classes_dir',
                      ...
                      default="object_detection/data/genome/1600-400-20")
...
if __name__ == '__main__':
  ...
  plt.savefig('./object_detection/images/result.png')
